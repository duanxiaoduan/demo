...
public class FileTransJavaDemo {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //}
        final String accessKeyId = "LTAIxIHcsW4Bgc2C";
        final String accessKeySecret = "aHwsO17QhNbVNfYnbT2BvExyt4GHth";
        final String appKey = "E5o7bih2uhlhjlUi";
        String fileLink = "http://dfs.gintong.com//group1/M00/0A/BC/CgIBzF0bSZ-ALACfAAII6hD8NRc105.mp3";
